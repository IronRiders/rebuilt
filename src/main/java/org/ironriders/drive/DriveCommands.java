...
public class DriveCommands {
    ...
    public DriveCommands(DriveSubsystem driveSubsystem) {
        ...
        this.driveSubsystem.publish("Invert Drive",
                Commands.runOnce(() -> driveSubsystem.switchDrive()));
        this.driveSubsystem.publish("Invert Rotation",
                Commands.runOnce(() -> driveSubsystem.switchRotation()));
    }
    ...
    public Command drive(Supplier<Translation2d> translation, DoubleSupplier rotation,
        ...
        return driveSubsystem.runOnce(() -> {
            driveSubsystem.drive(translation.get(), rotation.getAsDouble(),
    ...
    public Command jog(double robotRelativeAngleDegrees) {
        ...
        return driveSubsystem.runOnce(() -> {
            ...
            driveTeleop(velocity::getX, velocity::getY, () -> 0, false).repeatedly()
                    .until(() -> driveSubsystem.getPose().getTranslation()
