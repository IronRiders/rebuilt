...
public abstract class IronSubsystem extends SubsystemBase {
    ...
    public void log(String msg) {
        putTitleTextNotifcation(getThreadTimeString() + messagePrefix, msg);
        DogLog.log(getThreadTimeString() + messagePrefix, msg);
    }
    ...
    public void reportError(String message) {
        DriverStation.reportError(getThreadTimeString() + messagePrefix + message, false);
    ...
    public void reportWarning(String message) {
        DriverStation.reportWarning(getThreadTimeString() + messagePrefix + message, false);
