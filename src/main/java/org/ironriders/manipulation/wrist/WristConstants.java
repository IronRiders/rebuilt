...
public class WristConstants {
    ...
    public static final Double ENCODER_OFFSET = -0.465-0.07;
    // 132.0d;
    ...
    public static final TrapezoidProfile.Constraints CONSTRAINTS = new TrapezoidProfile.Constraints(100/360, 100/360); // TODO

    public static final Double JOSTLE_RANGE = 25d /360; // distance the wrist will move from the centerpoint while jostling; in degrees.
